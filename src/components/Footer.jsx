        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Your trusted partner in global trade solutions. We simplify
              international commerce with expertise, reliability, and seamless
              logistics.
            </p>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.instagram.com/axora_automation?igsh=d3ZxN29peDIzdHZm"
                target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="#top"
                  className="text-gray-300 hover:text-white transition duration-300 hover:translate-x-2 inline-block"
                >
                  Home
                </a>
              </li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Axora Global Import & Export. All
              rights reserved.
            </div>
